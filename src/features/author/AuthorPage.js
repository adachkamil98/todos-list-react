        ...
        <Content>
          <FlexContainer>
            <FlexItem>
              ...
              Swoje obowiązki wykonuję <em>bardzo</em> sumiennie i z zaangażowaniem. Wciąż
              rozwijam swoje umiejętności oraz stale zdobywam wiedzę np. z zakresu
              ...
              umiejętności miękkie oraz językowe są dzisiaj jednymi z kluczowych atutów na
              rynku pracy.
            </FlexItem>
            <FlexItem>
          ...
          <FlexItem>
            ...
            <SubHeaderParagraph>
              ...
              wykorzystaniem programów muzycznych. Po kilku latach programowania chciałbym
              zająć się automatyzacją procesów i rozwijać się w tym kierunku.
            </SubHeaderParagraph>
            <SubHeader>Marzenia</SubHeader>
            <SubHeaderParagraph>
              Największym marzeniem, które mam od lat jest doświadczenie życia jako
              mieszkaniec innych krajów. Chciałbym zobaczyć jak żyje się w innej kulturze,
              mając inną mentalność, innych ludzi wokół siebie oraz inną przyrodę. Idealne
              byłoby spędzenie kilku lat w różnych krajach takich jak np.:
            </SubHeaderParagraph>
            <List>
            ...
            <SubHeaderParagraph>
              W dalszej przyszłości chciałbym również zobaczyć Amerykę Południową i poznać
              ją od środka. <br></br>Patrząc 20 lat w przód, widzę siebie jako programistę
              i rękodzielnika utrzymującego swoją rodzinę z działalności firmy
              informatycznej i zajmującego się dla przyjemności np. wyrobem drewnianych
              dzieł sztuki.
            </SubHeaderParagraph>
          </FlexItem>
        </Content>
